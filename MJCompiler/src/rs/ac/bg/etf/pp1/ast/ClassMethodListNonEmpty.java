...
public class ClassMethodListNonEmpty extends ClassMethodList {

    private ClassMethodList ClassMethodList;
    private MethodDecl MethodDecl;

    public ClassMethodListNonEmpty (ClassMethodList ClassMethodList, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ClassMethodListNonEmpty(\n");
