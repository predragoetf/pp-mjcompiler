...
public class MethodStatementListNonEmpty extends MethodStatementList {

    private MethodStatementList MethodStatementList;
    private Statement Statement;

    public MethodStatementListNonEmpty (MethodStatementList MethodStatementList, Statement Statement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodStatementListNonEmpty(\n");
